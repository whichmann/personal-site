...
export const SUMMARY_INTRO = {
  ...
  name: "Karol Wichmann",
  description:
    "I write code, fix electronics, run teams, watch stars, and sometimes create some music.",
};
...
export const SUMMARY_ITEMS: SummaryItem[] = [
  ...
  },
  {
    id: "PwC-da",
    label:
      "My IT career started in Data Analysis, where I learned how to work with large datasets",
  ...
  },
  {
    id: "Engineering",
    label:
      "I have an engineering background and enjoy working with hardware and electronics",
    imageSrc: "/hard.png",
    description:
      "I spend weekends working with electronics, and hardware. I built a variety of devices, mostly simple gadgets, and fix whatever needs fixing at home. This hobby gives me a solid understanding of how things work and the importance of precision, attention to detail, and the value of hands-on experimentation.",
  },
  {
    id: "Side Projects",
    label:
      "In my free time, I explore new technologies and build things that interest me",
