...
export const GDANSK_WX_KEY = "karol-gdansk-wx-1";
export const WEATHER_CACHE_TTL = 15 * 60;
export const OPEN_METEO_FORECAST_URL =
  "https://api.open-meteo.com/v1/forecast?latitude=54.3520&longitude=18.6466&current=temperature_2m,weather_code&hourly=weather_code,precipitation,is_day&daily=temperature_2m_max&timezone=Europe%2FWarsaw&forecast_days=1";
...
export const pickGdanskWx = (data: OpenMeteoForecast): GdanskWx | null => {
